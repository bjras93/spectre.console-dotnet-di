...
public interface IConfigurator
{
    ...
    DynamicallyAccessedMemberTypes.PublicProperties | DynamicallyAccessedMemberTypes.PublicConstructors)] TSettings>(string name, Func<CommandContext, TSettings, int> func)
